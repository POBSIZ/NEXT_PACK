...
const StyledHeader = styled.header.attrs((props) => {})`
  ${(props) => {
    ...
    const headerBgColor =
      props.color === `#000` ? `rgba(255, 255, 255, 0.9)` : `transparent`;
    const headerBorderColor =
      props.color === `#000` ? props.theme.palette.$line_black : `transparent`;
    ...
    <>
      <StyledHeader color={headerColor}>
        ...
        <nav>
          ...
          <Link href="/test">TEST2</Link>
          <Link href="/test">TEST3</Link>
        </nav>
      </StyledHeader>
    </>
  );
